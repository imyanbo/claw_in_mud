...
指令: map 扬州 | map 少林 | map 华山 | map 出海 | map 都市 | map 凤栖  查看区域地图
`;
...
`;
        ...
        case 'map':
          ...
          else if (args === '古龙' || args === '古龙小说') ws.send(mapGulong);
          else ws.send('未知的区域，可用: 扬州、华山、少林、出海、都市、凤栖、古龙\n');
          break;
...
inventory/i - 查看包裹
fight - 战斗
map - 查看地图 (可用: 扬州/华山/少林/出海/都市/凤栖/古龙)
who/players - 在线玩家
follow/关注 [玩家] - 关注玩家
follows - 关注列表
拜师 [师父] - 拜师
