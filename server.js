...
const npcCatalog = {
  '老鸨': { alias: 'laobao', quote: '姑娘们都得吃饭，银子到了再谈情分。', money: 80, loot: ['胭脂'], role: '丽春院管事' },
  ...
  '客栈老板': { alias: 'innkeeper', quote: '住店打尖都行，先把银子放下。', money: 55, loot: ['账本'], role: '客栈掌柜' },
  ...
  '情报贩子': { alias: 'informer', quote: '想知道消息？那得看你出的价。', money: 90, loot: ['密报'], role: '消息贩子' },
  '神秘人': { alias: 'mysteryman', quote: '有些事，知道得越少越安全。', money: 66, loot: ['黑色令牌'], role: '神秘人物' },
  '镖头': { alias: 'escortchief', quote: '走镖最重要的，是人和货都得活着。', money: 75, loot: ['镖旗'], role: '镖局首领' },
  '镖师': { alias: 'escort', quote: '拳头硬，路上才有人让路。', money: 35, loot: ['飞镖'], role: '镖局好手' },
  '六扇门捕头': { alias: 'constablechief', quote: '六扇门办案，闲人退避。', money: 88, loot: ['缉捕文书'], role: '六扇门捕头' },
      ...
      switch (cmd) {
        ...
        case '对话':
          ...
          if (npcTalkName === '黑市商人') {
            ...
            const meta = getNpcMeta(npcTalkName);
            ws.send(`你和${formatNpcName(npcTalkName)}交谈了几句。\n${npcTalkName}说道：「${meta.quote}」\n>`);
          }
          break;
        ...
        case 'ask':
          ...
          const askMeta = getNpcMeta(askNpc);
          ws.send(`你向${formatNpcName(askNpc)}打听「${askTopic}」。\n${askNpc}摸了摸下巴，说道：「${askMeta.quote}」\n>`);
          break;
